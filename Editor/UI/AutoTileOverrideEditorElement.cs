...
{
    [Serializable]
    public class AutoTileOverrideEditorElement : VisualElement
    {
        ...
        private Dictionary<Texture2D, AutoTileOverrideTextureSource> textureToElementMap =
            new Dictionary<Texture2D, AutoTileOverrideTextureSource>();

        private AutoTileOverride m_AutoTile;

        public AutoTileOverride autoTile
        {
            get => m_AutoTile;
            internal set
            {
        ...
        public AutoTileOverrideEditorElement()
        {
            ...
            defaultProperties.Add(defaultTileKeyword);
        ...
        private void SaveTile()
        {
            ...
            {
                if (autoTile.m_AutoTileDictionary.TryGetValue(key, out AutoTileOverride.AutoTileOverrideData data))
                {
