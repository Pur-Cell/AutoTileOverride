...
namespace PurCell
{
    public class AutoTileOverrideTextureSource : ScrollView
    {
        private Dictionary<Sprite, AutoTileOverrideSpriteSource> m_SpriteToElementMap =
            new Dictionary<Sprite, AutoTileOverrideSpriteSource>();

        private Image m_TextureElement;
        private AutoTileOverrideSpriteSource.ClickState m_ClickState;
        private Action m_EditStopped;

        public AutoTileOverrideTextureSource(Texture2D texture2D, AutoTileMaskType maskType,
            ...
            .VerticalAndHorizontal)
        {
            ...
            m_ClickState = new AutoTileOverrideSpriteSource.ClickState();
            foreach (var assetAtPath in assetsAtPath)
            {
                ...
                var spriteImage = new AutoTileOverrideSpriteSource(spriteAsset, texture2D, m_ClickState, maskType);
